...
export class Initialization1730815145444 implements MigrationInterface {
    name = 'Initialization1730815145444'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."partenaire_de_la_charte_orgnisme_type_enum"`);
