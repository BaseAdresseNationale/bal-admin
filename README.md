...
| `NEXT_PUBLIC_BAL_WIDGET_SITES`    | Hostname des sites sur lesquels bal-widget est installé                              |
...
| ---                               | ---                                                                                  |
| `NEXT_PUBLIC_GRIST_URL`           | URL de base de l'instance Grist sans suffixe (ex: `https://grist.numerique.gouv.fr`) |
| `GRIST_API_KEY`                   | Token serveur Grist (ne doit jamais être exposé côté client)                         |
| `GRIST_WORKSPACE_ID`              | ID du workspace Grist où créer les documents de sondage                              |
| ---                               | ---                                                                                  |
