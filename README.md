...
| `NEXT_PUBLIC_BAL_WIDGET_SITES`    | Hostname des sites sur lesquels ban-widget est installé                |
...
| ---                               | ---                                                                    |
| `GRIST_API_URL`                   | URL de base de l'API Grist (ex: `https://grist.numerique.gouv.fr/api`) |
