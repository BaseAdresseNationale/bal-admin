...
export const PartenaireItem = ({_id, _created, type, name, signatureDate, services}: PartenaireDeLaChartType) => (
  <tr key={_id}>
    <td className='fr-col fr-my-1v'>
      <Badge severity={getPartenaireTypeColor(type)} noIcon>{type}</Badge>
    </td>
    <td className='fr-col fr-my-1v'>
      {name}
    </td>
    <td className='fr-col fr-my-1v'>
      {getDate(signatureDate, _created)}
    </td>
    <td className='fr-col fr-my-1v'>
