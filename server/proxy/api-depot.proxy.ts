...
const API_DEPOT_DEMO_URL =
  process.env.NEXT_PUBLIC_API_DEPOT_DEMO_URL ||
  "https://plateforme-bal.adresse.data.gouv.fr/api-depot-demo";
...
async function updateClient(req, res) {
  const response = await req.client.put(`clients/${req.params.clientId}`, {
    json: req.body,
  });
  forward(response, res);
}
